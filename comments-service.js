// Comments Service - Browser Compatible Version
(function() {
   ...
   */
  window.getComments = async function(studentNumber, site) {
    if (!studentNumber) {
   ...
   */
  window.postComment = async function(studentNumber, site, text, sender = 'Anonymous') {
    if (!studentNumber) {
      throw new Error('Student number is required');
    }
    if (!site || !text) {
   ...
   */
  window.deleteComment = async function(studentNumber, site, commentId) {
    if (!studentNumber) {
      throw new Error('Student number is required');
    }
    if (!site || !commentId) {
